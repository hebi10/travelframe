...
export default function TripClipScreen() {
  ...
  const executeSelectedExport = async ({
    ...
    try {
      ...
      setExportProgress({
        ...
        percent: 88,
        title: "핸드폰에 저장 중",
        detail: "완성된 MP4 영상을 Body Frame 앨범에 저장하고 있습니다."
      });
      ...
      setExportProgress({
        ...
        title: "저장 완료",
        detail: backupWarning
          ? "저장한 영상은 핸드폰 Body Frame 앨범에 저장됐습니다. 클라우드 백업은 나중에 다시 시도할 수 있습니다."
  ...
  return (
    ...
    <View style={styles.screenRoot}>
      ...
      >
        <GestureHandlerRootView style={styles.frameFitModalGestureRoot}>
