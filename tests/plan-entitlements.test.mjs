...
assert.equal(PLAN_ENTITLEMENTS.guest.canExportVideo, true);
assert.equal(PLAN_ENTITLEMENTS.guest.weeklyVideoExportLimit, 1);
...
assert.equal(PLAN_ENTITLEMENTS.guest.maxProgressVideoSeconds, null);
assert.equal(PLAN_ENTITLEMENTS.guest.maxProjectCount, 1);

assert.equal(PLAN_ENTITLEMENTS.free.canExportVideo, true);
assert.equal(PLAN_ENTITLEMENTS.free.weeklyVideoExportLimit, 0);
...
assert.equal(PLAN_ENTITLEMENTS.free.maxProgressVideoSeconds, null);
assert.equal(PLAN_ENTITLEMENTS.free.maxProjectCount, 1);

assert.equal(PLAN_ENTITLEMENTS.ad_remove.canExportVideo, true);
assert.equal(PLAN_ENTITLEMENTS.ad_remove.weeklyVideoExportLimit, 0);
...
assert.equal(PLAN_ENTITLEMENTS.ad_remove.maxProgressVideoSeconds, null);
assert.equal(PLAN_ENTITLEMENTS.ad_remove.maxProjectCount, 2);

assert.equal(PLAN_ENTITLEMENTS.pro.weeklyVideoExportLimit, 0);
...
assert.equal(PLAN_ENTITLEMENTS.pro.maxProgressVideoSeconds, null);
...
assert.equal(PLAN_ENTITLEMENTS.plus.weeklyVideoExportLimit, 0);
...
assert.equal(PLAN_ENTITLEMENTS.plus.maxProgressPhotos, 365);
assert.equal(PLAN_ENTITLEMENTS.plus.maxProgressVideoSeconds, null);
...
assert.equal(PLAN_ENTITLEMENTS.expert.weeklyVideoExportLimit, 0);
...
assert.equal(PLAN_ENTITLEMENTS.expert.maxProgressPhotos, 365);
...
assert.equal(getWeeklyVideoExportLimit(proEntitlements), 0);
